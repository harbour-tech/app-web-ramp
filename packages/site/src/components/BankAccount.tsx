...
import {IbanCoordinates, ScanCoordinates} from "@/harbour/gen/ramp/v1/public_pb";
...
export const BankAccount: FunctionComponent<BankAccountProps> = ({account, onChange}) => {
...
const Iban: FunctionComponent<IbanProps> = ({iban, onChange}) => {
  ...
  return (
    <div className="w-full max-w-sm items-center">
      ...
      <Input type="text" id="iban" placeholder="IBAN" readOnly={!onChange} value={iban.iban}
  ...
  return (
    <>
      <div className="w-full max-w-sm items-center">
        ...
        <Input type="text" id="sortCode" placeholder="Sort Code" readOnly={!onChange} value={scan.sortCode} onChange={onSortCodeChange}/>
      </div>
      <div className="w-full max-w-sm items-center">
        <Label htmlFor="accountNumber">Account Number</Label>
        <Input type="text" id="accountNumber" placeholder="Account Number" readOnly={!onChange} value={scan.accountNumber} onChange={onAccountNumberChange}/>
      </div>
    </>
