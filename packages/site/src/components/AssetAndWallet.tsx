...
export const AssetAndWallet: FunctionComponent<AssetAndWalletProps> = ({
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Asset and Wallet</CardTitle>
        <CardDescription>{walletDescription}</CardDescription>
        <CardDescription>{assetDescription}</CardDescription>
      </CardHeader>
      <CardContent>
        <SelectAsset
          onValueChange={(value) => {
