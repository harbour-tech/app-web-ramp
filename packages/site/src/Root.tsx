  ...
  return (
    <>
      <div className="relative h-full w-full z-10">
        <div className="flex flex-col justify-center items-center  gap-2 pt-8 z-10">
          <section className="max-w-[680px] flex-col justify-center items-center p-8 animate-in animate-slide-up">
