  ...
  return (
    <div className="container">
      <div className="flex justify-center items-end  gap-2 py-8 md:py-8 md:pb-8 lg:py-8 lg:pb-8">
        ...
        <section
          className="max-w-[680px] flex-col items-center">
          <h1
            className="text-center text-3xl font-bold leading-tight tracking-tighter md:text-6xl lg:leading-[1.1] hidden md:block">
            Ramp it</h1>
        </section>
          ...
          <svg width="154" height="18" viewBox="0 0 154 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              fill="black"/>
            <path d="M3.91574 0.6875H0.234375V6.57768H3.91574V0.6875Z" fill="black"/>
            <path d="M19.615 11.0188H15.9336V17.3127H19.615V11.0188Z" fill="black"/>
            <path
